...
from apps.deals.models import Deal, Payment, PaymentApproval, PaymentInvoice, ActivityLog
...
from apps.notifications.models import Notification, NotificationSettings, NotificationTemplate
