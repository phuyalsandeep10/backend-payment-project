...
class HasTeamPermission(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        required_perms_map = {
            ...
            'destroy': ['remove_team'],
            'add_members': ['edit_team_details'],  # Allow adding members with team edit permission
            'remove_member': ['edit_team_details'],  # Allow removing members with team edit permission
        }
